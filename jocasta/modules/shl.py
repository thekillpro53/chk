...
from .func.shl_defs import *
from .func.rand_user import random_user_api, PROXIES



@register(cmds="shl", is_text=True)
@gate_info_dec('shl')
@get_strings_dec("card_check")
@get_spam_dec()
async def shl(message, gate_info, user_info,start_time, lang):
    try:
        ...
        r_text, r_logo, r_respo = get_response_shl(last)
        if 'Charged $24' in r_text:
