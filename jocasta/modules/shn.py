...
from .func.shn_defs import *
from .func.rand_user import random_user_api, PROXIES



@register(cmds="shn", is_text=True)
@gate_info_dec('shn')
@get_strings_dec("card_check")
@get_spam_dec()
async def shn(message, gate_info, user_info,start_time, lang):
    try:
        ...
        r_text, r_logo, r_respo = get_response_shn(last)
