...
from jocasta import BOT_ID,dp
from aiogram.dispatcher.filters import BoundFilter
from jocasta.modules.filters.admins_rights import get_admins_rights, check_admin_rights
...
class UserRestricting(Filter):
    ...
    async def no_rights_msg(self, message, required_permissions):
        strings = await get_strings(
            message.message.from_user.id if hasattr(message, "message") else message.from_user.id,
            "global",
        )
